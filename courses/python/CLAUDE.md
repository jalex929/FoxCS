...
**Corrected 2026-09-04 — this section was stale since the 2026-08-04 MVP pivot and no longer matched reality.** Unit 01 (`content/unit_01_what_is_programming/`) is built and live on Moodle: Lessons 01.1–01.4 fully built across the 4-module-era pattern, 01.5–01.6 built under the newer tabbed-Lesson-plus-separate-Practice pattern (both now superseded by the 2026-09-04 5-module structure — see `../../decisions-log.md` and `../../worklog.md`). **Unit 02 (`content/unit_02_...`) has two lessons drafted: 02.0 Getting Ready for Certification** (added 2026-09-08 — Certiport/GMetrix account setup, a one-time orientation step, not a Variables & Data skill lesson; see `../../02-authoring-system/certiport-gmetrix-account-setup.md`) **and 02.1 Variables and Memory** (built 2026-09-04, the first lesson authored under the new module structure from the start rather than retrofitted). 02.1 is deployed to the sandbox course only (`sandbox-adaptive-demo`), not any real course, and not yet reviewed by Jay; 02.0 hasn't been deployed anywhere yet either. Lessons 02.2 onward are still unbuilt. See `course-plan.md`'s pointer to the new `skills-map.md` (imported 2026-09-08 from the "FoxCS Python — Course Unit Skills Map" Google Doc) before authoring any of them. See `../../worklog.md` for exactly what's mid-flight.
