...
- [ ] 02.7 Reading Code with Variables — due Tue Sept 15 — **not built 2026-09-08**. Needs a Code Stepper component (first real use of it anywhere in this course, per skills-map.md's "Code Stepper" section, lines 644-780) — a genuinely new UI component, not a lesson that fits the 02.2-02.5 template. Scope this as its own build, not a quick add-on. **Also carries the Assignment Operator content resolved 2026-09-09** — Workbook p.23 (Assignment Order, Objective 1.3.1, `131-assignment.py`) and p.32 (Using Assignment Operators, Objective 1.4.1, `141-assignment.py`) as a companion Fill-in-the-Blanks/Workbook Page piece alongside the Code Stepper content, not blended into it.
