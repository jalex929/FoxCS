...
- [ ] 02.6 Type Conversion — due Mon Sept 14 — **not built 2026-09-08**. Needs the Read→Identify→Test→Revise→Ask troubleshooting routine woven in per skills-map.md, not just a 5-skill-node lesson like 02.2-02.5.
