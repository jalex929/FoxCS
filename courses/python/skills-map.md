...
**Cross-check still pending:** this file hasn't yet been reconciled against `gmetrix-content-mapping.md` or `python-certification-workbook-map.md` -- neither exists in this repo or Drive yet (checked both 2026-09-08). Once uploaded, re-pass this file and `course-plan.md`'s GMetrix Domain Mapping section against them.
