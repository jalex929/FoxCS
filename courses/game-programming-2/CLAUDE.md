...
- Whether Phase 4-5 (3D transfer through capstone, course-plan.md Units 21-29) needs to be compressed to land before the AP-testing/senior-checkout pacing window, or whether the capstone's later stages are treated as continued, real, student-driven project work through that window (not "low-stakes" — see `../../CLAUDE.md`'s 2026-08-18 correction) — not decided, see `course-plan.md`'s Pacing section.
