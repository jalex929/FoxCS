<?php
// build-lesson-01-06-feedback.php
//
// Builds Lesson 01.6's (Common Syntax Mistakes) Feedback/Reflection as a native
// Moodle mod_feedback activity, matching 01.4/01.5's pattern exactly. Same
// 6-question shape, vocab checklist swapped to this lesson's 5 real terms.
//
// Run: sudo -u www-data php build-lesson-01-06-feedback.php
...
foxcs_add_checkbox($feedback, 'Vocab self-check',
    ...
    "SyntaxError: an error from breaking Python's grammar rules\nNameError: an error from Python not finding something by an exact name\nEOL: \"End Of Line\", often from a missing closing quote\nsyntax: the grammar rules for writing valid code\nparenthesis: the ( or ) symbol used to call a function\nNone. I can explain all 5 words");
