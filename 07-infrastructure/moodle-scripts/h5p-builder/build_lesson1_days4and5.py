...
day4_blocks = [
    ...
    ("essay", "<p>Think back to Lesson 1's error types. Did you notice any mistakes where you knew what to do but made an Execution Error? Did any questions feel hard mainly because you didn't understand what they were asking (a Comprehension Error)?</p>", "Type your answer here."),
...
build_column(day4_blocks, "Lesson 1: ACT Math Baseline Reflection (Interactive)", "/tmp/h5p-build/lesson-1-baseline-reflection.h5p")

# ---- Day 5: Lesson 1 Reflection -- Build Your Starting Strategy ----

day5_blocks = [
    ("text", "<h2>Build Your Starting Strategy</h2><p>Lesson 1 gave you two tools you'll use all year: the five-question problem-solving routine (STOP &rarr; FIND &rarr; CONNECT &rarr; TRY &rarr; CHECK) and the five error types (Knowledge, Process, Execution, Comprehension, Strategy). Use them to set your starting point for Quarter 1.</p>"),
...
build_column(day5_blocks, "Lesson 1: Reflection -- Build Your Starting Strategy (Interactive)", "/tmp/h5p-build/lesson-1-final-reflection.h5p")
