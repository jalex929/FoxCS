...
for the original Lesson 1 Check, before this existed). Built 2026-08-30 while
authoring the Lesson 1 ACT Math Baseline.
...
## `build_lesson1_baseline_quickref.py` / `build_lesson1_days4and5.py`
...
```
python3 build_lesson1_days4and5.py   # writes .h5p files to /tmp/h5p-build/
...
One-off script (2026-08-30) that consolidated Lesson 1 from 16 visible Moodle
