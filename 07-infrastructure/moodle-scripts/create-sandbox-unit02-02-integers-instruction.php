...
// Source: ../../courses/python/content/unit_02_variables_and_data/lesson_02_02_integers/01_instruction.html
//
...
$sourcepath = $repo . '/courses/python/content/unit_02_variables_and_data/lesson_02_02_integers/01_instruction.html';

$existing = $DB->get_record('course_modules', ['course' => $course->id, 'idnumber' => 'sandbox-u02-02-instruction']);
if ($existing) {
...
$moduleinfo->name = '2.2 Integers: Instruction (sandbox)';
$moduleinfo->idnumber = 'sandbox-u02-02-instruction';
